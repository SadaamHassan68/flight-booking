...
// Build query
$sql = "SELECT * FROM flights WHERE status = 'active' AND available_seats > 0 AND departure_date >= CURDATE()";
$params = [];
...
$flights = $db->fetchAll($sql, $params);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo SITE_NAME; ?> - Flights</title>
                ...
                <div class="col-12">
                    <h3 class="mb-4">
                        ...
                        <?php else: ?>
                            Available Flights
                        <?php endif; ?>
                        <span class="badge bg-primary ms-2"><?php echo count($flights); ?> flights</span>
                    </h3>
                </div>
            </div>
                            ...
                            <div class="card h-100 flight-card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <div>
                                            <h5 class="card-title mb-1"><?php echo htmlspecialchars($flight['flight_number']); ?></h5>
                                            <small class="text-muted">Flight Number</small>
                                        </div>
                                        <div class="text-end">
                                            <h4 class="text-success mb-1"><?php echo formatPrice($flight['price']); ?></h4>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div><?php echo $flight['available_seats']; ?></div>
                                        </div>
                                    </div>
